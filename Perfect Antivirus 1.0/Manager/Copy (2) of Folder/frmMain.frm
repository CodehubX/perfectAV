...
If KillProcessById(LV1.ListItems(LV1.SelectedItem.Index).SubItems(2)) = True Then
    UniMsgBox "D9a4 ta81t " & LV1.SelectedItem.Text
    GetProcess LV1, ImA, Pic
Else
    UniMsgBox "Kho6ng ta81t d9u7o75c " & LV1.SelectedItem.Text
End If
End Sub
