...
Shell "notepad " & ChrW(34) & txt.Text & ChrW(34), vbNormalFocus
...
If Bar1.Value > Bar1.Max - 1 Then
txt.Visible = True
Timer1.Enabled = False
cmdStart.Enabled = True
cmdSave.Enabled = True
UniMsgBox "D9a4 Kie63m Tra Xong!", vbOKOnly + vbInformation, "OK"
End If
End Sub
...
& vbCrLf _
& vbCrLf _
& " [1] - Ca1c chu7o7ng tri2nh d9ang cha5y trong bo65 nho71:" & vbCrLf & vbCrLf)
'/////////////////////////////////////
DoEvents
Dim ColItems
Dim ObjItem
...
For Each ObjItem In ColItems
   ...
   If IsNull(ObjItem.ExecutablePath) = False Then txt.Text = txt.Text & " " & ObjItem.ExecutablePath & vbCrLf
DoEvents
Next
...
txt.Text = txt.Text & vbCrLf & ToUnicode(" [9] - Tho6ng tin ve62 ma1y ti1nh:" & vbCrLf & vbCrLf & vbCrLf)
