...
Private Sub cmdVirusReportOK_Click()
        ...
        '<EhHeader>
        On Error GoTo cmdVirusReportOK_Click_Err
...
cmdVirusReportOK_Click_Err:
        WriteErr Time & "-" & Date & " - " & Err.Description & " - " & "in PerfectAntivirus2009.frmVirusReport.cmdVirusReportOK_Click " & "at line " & Erl
...
Public Sub ShowReport(TotalFile, StartUpFile, ProcessFile, Virus, HoanThanh, Time)
        ...
        '</EhHeader>
100     With Me
102         .lblTime.Caption = Time
104         .lblTotalFile.Caption = TotalFile
106         .lblHoanThanh.Caption = HoanThanh
108         .lblTotalProcess.Caption = ProcessFile
110         .lblTotalStartUp.Caption = StartUpFile
112         .lblTotalVirus.Caption = Virus
114         .Show
        End With
...
ShowReport_Err:
        WriteErr Time & "-" & Date & " - " & Err.Description & " - " & "in PerfectAntivirus2009.frmVirusReport.ShowReport " & "at line " & Erl
